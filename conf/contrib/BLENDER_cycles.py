    ...
    for bobj in bpy.data.objects:
        if (bobj.type == 'MESH'):
            ...
            for image in bpy.data.images:
                ...
                if (texName == 'pumpkin_side_jack'):
                    texName = 'pumpkin_side_jack'
                if (texName == 'pumpkin_top_jack'):
                    texName = 'pumpkin_top_jack'
            ...
            if (bobj.name == 'armor_enchanted'):
                ...
                if texImageFound == False:
                    ...
                    mainShader = {
                        ...
                        "default": makeMcMainDiffuse, 
                        "tallgrass": makeMcMainTranslucent, 
                        "torch_flame": makeMcMainTranslucent,
												"redtorch_lit": makeMcMainTranslucent,
                        ...
                        "rose": makeMcMainTranslucent,
                        "flower": makeMcMainTranslucent,
												
                        
                        "pumpkin_jack": makeMcMainTranslucent,
                        "pumpkin_side_jack": makeMcMainTranslucent,
                        "pumpkin_top_jack": makeMcMainTranslucent,
                    ...
                    if (
												(bobj.name == 'redstoneLight_lit') or
												(bobj.name == 'blockRedstone') or
												(bobj.name == 'redstoneDust_cross_lit') or
												(bobj.name == 'redstoneDust_line_lit') or
												(bobj.name == 'redtorch_lit') or 
                        (bobj.name == 'sea_lantern') or 
                        (bobj.name == 'torch_flame') or 
                        (bobj.name == 'fire_0') or 
                        (bobj.name ==  'pumpkin_jack') or
                        (bobj.name ==  'pumpkin_top_jack') or
                        (bobj.name ==  'pumpkin_side_jack')
                    ):
                        mat.cycles.sample_as_light = True
                        ...
                        if (bobj.name ==  'pumpkin_jack'):
                            nEmit.inputs[0].default_value = (1, 0.46, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name ==  'pumpkin_top_jack'):
                            nEmit.inputs[0].default_value = (1, 0.46, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name ==  'pumpkin_side_jack'):
                            nEmit.inputs[0].default_value = (1, 0.46, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name.startswith( 'redtorch_lit')):
                            nEmit.inputs[0].default_value = (1, 0, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name.startswith( 'redstoneDust_cross_lit')):
                            nEmit.inputs[0].default_value = (1, 0, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name.startswith( 'redstoneDust_line_lit')):
                            nEmit.inputs[0].default_value = (1, 0, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name.startswith( 'blockRedstone')):
                            nEmit.inputs[0].default_value = (1, 0, 0, 1)
                            nEmit.inputs["Strength"].default_value = 7
                        if (bobj.name.startswith( 'redstoneLight_lit')):
                            nEmit.inputs[0].default_value = (1, 0.11, 0, 1)
                            nEmit.inputs["Strength"].default_value = 20
